...
declare type ParsedJSON = Record<string, unknown> | boolean | number | string;
...
export interface cityssmGlobal {
    ...
    postJSON: (fetchUrl: string, formEleOrObject: unknown | HTMLFormElement, responseFunction: (responseJSON: ParsedJSON) => void) => void;
    ...
    confirmModal: (titleString: string, bodyHTML: string, okButtonHTML: string, contextualColorName: BulmaContextualColors, okButtonCallbackFunction: () => void, cancelButtonCallbackFunction?: () => void) => void;
